...
See the [regression fixtures](https://github.com/sgl-project/sglang/tree/main/test/nccl_ep_test)
for one-GPU lifecycle tests. Native multi-rank benchmark and profiling drivers
are maintained separately; the fixture README links their historical versions.
